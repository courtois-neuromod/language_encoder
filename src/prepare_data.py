...
gentles_train_set = build_text_input(data_config, training_seasons[:1])
gentles_train_set = gentles_train_set[:data_length]
...
for i, split in tqdm(enumerate(splits), desc="Processing encoding"):
    ...
    print(f"len_gentles_train: {len(gentles_train)}")
